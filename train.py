...
# tb logging
tb_log = False # disabled by default
# data
dataset = 'openwebtext'
...
if ddp:
    device_ids = [ddp_local_rank] if torch.cuda.is_available() else None
...
if tb_log and master_process:
    ...
    writer = SummaryWriter(log_dir=f'{out_dir}/tensorboard/{time_str}')
